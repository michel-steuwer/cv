...
\cvline{}{
  \begin{itemize}
    \item Artifact Evaluation Chair of the 16{\footnotesize th} Int. Symposium on Code Generation and Optimization (CGO\,2018)
    \item Main Organiser of the 7{\footnotesize th} UK Many-Core Developer Conference, UKMAC 2017
\end{itemize}
}
% \vspace{-1em}
