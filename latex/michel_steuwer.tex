...
\vspace{-1em}
\subsection{Organisational Activities}
\cvline{}{
  \begin{itemize}
...
%\cvline{}{
%  \begin{itemize}
    \item I co-organise the seminar of the \emph{Programming Language Research Programme} at the School of Informatics in Edinburgh together with James Cheney, an series of talks covering a broad range of topics related to programming languages.
