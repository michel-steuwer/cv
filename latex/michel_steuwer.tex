...
\cvline{}{Nominated as one of 34 candidates from all German, Austrian, and Swiss Universities for the \strong{prize for best dissertation} awarded by the German Informatics Society.}
...
\cvline{}{
  \begin{itemize}
    \item \strong{Best Paper Award Winner} at the International Symposium on Code Generation and Optimization \strong{CGO 2018}.
    \item \strong{HiPEAC Paper Award Winner} for our paper at the International Conference on Architectural Support for Programming Languages and Operating Systems \strong{ASPLOS 2018}.
    \item \strong{Most cited papers} of the International Conference on Functional Programming \strong{ICFP\,2015} and the International Symposium on Code Generation and Optimization \strong{CGO\,2017} \& \strong{2018}.
    \item PhD thesis honoured with the highest possible grade \strong{Summa cum laude}
    \item \strong{Nominated} as one of 34 candidates for the \strong{prize for best dissertation} completed in 2015 in Informatics at a German, Austrian, or Swiss University.
...
\cvline{}{
  \begin{itemize}
    ...
    \item Member of the UK Manycore Research, Innovation and Opportunities Network (MaRIONet)
...
\cvline{}{
  \begin{itemize}
    \item \strong{Artifact Evaluation Chair and Co-Chair} of \highlight{CGO 2020, 2019, 2018}
    \item \strong{Artifact Evaluation Chair} of \highlight{CC 2020}
    \item \strong{Artifact Evaluation Chair and Co-Chair} of \highlight{LCTES 2019 and 2018}
    \item \strong{Local Organisation Co-Chair} of the \highlight{HiPEAC Computer Systems Week} in April 2019
    \item \strong{Local Organisation Co-Chair} of \highlight{SPLS}, the Scottish Programming Language Seminar, 03/2018
    \item \strong{Web \& Publicity Chair} of \highlight{CC 2018}
    \item \strong{Local Organisation Chair} of \highlight{UKMAC 2017}, the 7{\footnotesize th} UK Many-Core Developer Conference
\end{itemize}
}
\subsection{Program Committees}
\cvline{}{
  \begin{itemize}
    \item \strong{\href{http://cgo.org}{CGO}\,\href{http://cgo.org/}{2020} and \href{http://cgo.org/cgo2019/}{2019}}: SIGMICRO/SIGPLAN Intl. Symp. on Code Generation and Optimization
    \item \strong{ICPP 2020}: International Conference on Parallel Processing
    \item \strong{CC\,\href{https://cc-conference.github.io/20/}{2020}}: International Conference on Compiler Construction
    \item \strong{\href{https://conf.researchr.org/series/gpce}{GPCE}\,\href{https://conf.researchr.org/home/gpce-2019}{2019}}: SIGPLAN Intl. Conference on Generative Programming: Concepts \& Experiences
    \item \strong{LCTES\,\href{https://conf.researchr.org/home/LCTES-2019}{2019} and \href{https://conf.researchr.org/track/LCTES-2018/LCTES-2018-papers}{2018}}: SIGPLAN/SIGBED Conference on Languages, Compilers, Tools and Theory for Embedded Systems
    \item \strong{\href{http://hlpp.free.fr/}{HLPP}\,\href{https://www.ida.liu.se/conferences/hlpp2019/}{2019}, \href{https://www.univ-orleans.fr/lifo/equipes/LMV/hlpp2018/index.php}{2018}, \href{https://hlpp2017.infor.uva.es/}{2017}, and \href{http://hlpp2016.uni-muenster.de/}{2016}}: Intl. Symp. on High-Level Parallel Programming and Apps.
    \item \strong{\href{https://omasew.github.io/}{OMASE\,2019}}: Optimization, Modeling, Analysis and Space Exploration Workshop
    \item \strong{DHPCC++\,\href{http://sycl.tech/distributed-heterogeneous-programming-in-c-cpp-dhpccpp19.html}{2019} and \href{http://www.iwocl.org/iwocl-2018/dhpcc/}{2018}}: Workshop on Distr. and Heterogeneous Programming in C/C++
    \item \strong{\href{https://scalcom2016.sciencesconf.org/}{ScalCom\,2016}}: IEEE Intl. Conference on Scalable Computing and Communications
\end{itemize}
}
\subsection{Artifact Evaluation Committees}
\cvline{}{
  \begin{itemize}
    \item \strong{ICFP\,2017}: ACM SIGPLAN International Conference on Functional Programming
    \item \strong{CGO\,2017}: ACM SIGMICRO/SIGPLAN Intl. Symposium on Code Generation and Optimization
    \item \strong{PACT\,2016}: Intl. Conference on Parallel Architectures and Compilation Techniques
  \end{itemize}
}
\subsection{Local Community Activities}
\cvline{}{
  \begin{itemize}
    \item I organise \emph{Upwards}, a seminar series discussing all aspects of research life to facilitate knowledge sharing among academics and providing career advices.
    \item I co-organised the \emph{Programming Language Research Programme} at the School of Informatics in Edinburgh together with James Cheney, including a seminar series covering a broad range of topics related to programming languages.
...
\cvline{}{I regularly act as reviewer for journals, funding agencies and external reviewer for conferences.}
\cvline{}{I have reviewed for the following journals: ACM TODS, ACM TACO, ACM Computing Surveys, Elsevier's Science of Computer Programming Journal, Springer's The Journal of Supercomputing, Wiley's Software: Practice and Experience.}
\cvline{}{I have been external reviewer for: CC, CGO, Euro-Par, EuroMPI, CCGrid, and ParCo.}
% \cvline{}{
%   Reviewer for journals:
%   \begin{itemize}
%     \item ACM Transactions on Database Systems (TODS)
...
\cventry{2019}{Hosting of a visiting researcher (2 Month)}{From the University of Münster}{Germany}{}
...
\cvline{}{
  \begin{itemize}
    ...
    \item Robert Hundt and Jacques Pienaar, Google
    \item Aaron Smith, Microsoft Research
  \end{itemize}
}
...
\cvline{}{\strong{Overall citations: 553}, \strong{h-index: 12}, \strong{i-index: 18}}
\cvline{}{\small (from Google Scholar accessed on the 13th of June 2019)}
...
\cvline{\since{} 11/2018}{PhD studies of Thomas Koehler on\newline \emph{Practical development of efficient and portable image processing applications in Lift}}
...
\cvline{\since{} 10/2018}{PhD studies of Bastian K{\"o}pcke on\newline \emph{Exploiting Specialised Hardware with Lift}}
