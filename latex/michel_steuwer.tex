...
\cvline{}{
  \begin{itemize}
    \item \textcolor{color1}{\textbf{Artifact Evaluation Chair} of LCTES 2018}, the 19{\footnotesize th} Annual ACM SIGPLAN/SIGBED Conference on Languages, Compilers, Tools and Theory for Embedded Systems
    \item \textcolor{color1}{\textbf{Local Organisation Co-Chair} of SPLS}, the Scottish Programming Language Seminar, 03/2018
    \item \textcolor{color1}{\textbf{Artifact Evaluation Chair} of CGO 2018}, the Intl. Symp. on Code Generation and Optimization
    \item \textcolor{color1}{\textbf{Web \& Publicity Chair} of CC 2018}, the 27{\footnotesize th} Intl. Conference on Compiler Construction
    \item \textcolor{color1}{\textbf{Local Organisation Chair} of UKMAC 2017}, the 7{\footnotesize th} UK Many-Core Developer Conference
\end{itemize}
}
\subsection{Program Committees}
\cvline{}{
  \begin{itemize}
    \item \textcolor{color1}{\textbf{CGO\,2019}}: ACM SIGMICRO/SIGPLAN Intl. Symposium on Code Generation and Optimization
    \item \textcolor{color1}{\textbf{HLPP\,2018}}: 11{\footnotesize th} Intl. Symposium on High-Level Parallel Programming and Applications
    \item \textcolor{color1}{\textbf{LCTES\,2018}}: 19{\footnotesize th} Annual ACM SIGPLAN/SIGBED Conference on Languages, Compilers, Tools and Theory for Embedded Systems
    \item \textcolor{color1}{\textbf{DHPCC++\,2018}}: 2{\footnotesize nd} Workshop on Distributed and Heterogeneous Programming in C/C++
    \item \textcolor{color1}{\textbf{HLPP\,2017}}: 10{\footnotesize th} Intl. Symposium on High-Level Parallel Programming and Applications
    \item \textcolor{color1}{\textbf{HLPP\,2016}}: 9{\footnotesize th} Intl. Symposium on High-Level Parallel Programming and Applications
    \item \textcolor{color1}{\textbf{ScalCom\,2016}}:16{\footnotesize th} IEEE Intl. Conference on Scalable Computing and Communications
\end{itemize}
}
\subsection{Artifact Evaluation Committees}
\cvline{}{
  \begin{itemize}
    \item \textcolor{color1}{\textbf{ICFP\,2017}}: 22{\footnotesize th} ACM SIGPLAN International Conference on Functional Programming
    \item \textcolor{color1}{\textbf{CGO\,2017}}: 15{\footnotesize th} International Symposium on Code Generation and Optimization
    \item \textcolor{color1}{\textbf{PACT\,2016}}: 25{\footnotesize th} Intl. Conference on Parallel Architectures and Compilation Techniques
  \end{itemize}
}
...
\cvline{}{\textbf{Overall citations: 412}, \textbf{h-index: 10}, \textbf{i-index: 11}}
\cvline{}{\small (from Google Scholar accessed on the 27th of June 2018)}
