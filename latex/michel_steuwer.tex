...
\cvline{}{
  \begin{itemize}
    ...
    \item Active member of the Manycore Research, Innovation and Opportunities Network (MaRIONet)
    \item Active member of the European Network on High Performance and Embedded Architecture and Compilation (HiPEAC)
