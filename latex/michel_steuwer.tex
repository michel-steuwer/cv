...
\usepackage[left=3cm,right=3.5cm,top=2.5cm,bottom=3cm]{geometry}
...
% personal data
\firstname{\color{color1}\rmfamily\bfseries Dr. Michel}
\familyname{Steuwer}
\address{%
  Informatics Forum\\
  10 Crichton Street\\
...
\begin{tikzpicture}[remember picture, overlay]
  \node [anchor=north west, inner ysep=10mm, inner xsep=10mm]  at (current page.north west)
