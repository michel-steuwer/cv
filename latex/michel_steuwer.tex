...
\newcommand{\highlight}[1]{\textcolor{color1}}
...
\cvline{}{
  \begin{itemize}
    \item \strong{Best Paper Award} at the International Symposium on Code Generation and Optimization (CGO) 2018.
...
\cvline{}{
  \begin{itemize}
    \item \strong{Artifact Evaluation Chair} \highlight{of LCTES 2018}, the 19{\footnotesize th} Annual ACM SIGPLAN/SIGBED Conference on Languages, Compilers, Tools and Theory for Embedded Systems
    \item \strong{Local Organisation Co-Chair} \highlight{of SPLS}, the Scottish Programming Language Seminar, 03/2018
    \item \strong{Artifact Evaluation Chair} \highlight{of CGO 2018}, the Intl. Symp. on Code Generation and Optimization
    \item \strong{Web \& Publicity Chair} \highlight{of CC 2018}, the 27{\footnotesize th} Intl. Conference on Compiler Construction
    \item \strong{Local Organisation Chair} \highlight{of UKMAC 2017}, the 7{\footnotesize th} UK Many-Core Developer Conference
\end{itemize}
}
\subsection{Program Committees}
\cvline{}{
  \begin{itemize}
    \item \strong{CGO\,2019}: ACM SIGMICRO/SIGPLAN Intl. Symposium on Code Generation and Optimization
    \item \strong{HLPP\,2018}: 11{\footnotesize th} Intl. Symposium on High-Level Parallel Programming and Applications
    \item \strong{LCTES\,2018}: 19{\footnotesize th} Annual ACM SIGPLAN/SIGBED Conference on Languages, Compilers, Tools and Theory for Embedded Systems
    \item \strong{DHPCC++\,2018}: 2{\footnotesize nd} Workshop on Distributed and Heterogeneous Programming in C/C++
    \item \strong{HLPP\,2017}: 10{\footnotesize th} Intl. Symposium on High-Level Parallel Programming and Applications
    \item \strong{HLPP\,2016}: 9{\footnotesize th} Intl. Symposium on High-Level Parallel Programming and Applications
    \item \strong{ScalCom\,2016}:16{\footnotesize th} IEEE Intl. Conference on Scalable Computing and Communications
\end{itemize}
}
\subsection{Artifact Evaluation Committees}
\cvline{}{
  \begin{itemize}
    \item \strong{ICFP\,2017}: 22{\footnotesize th} ACM SIGPLAN International Conference on Functional Programming
    \item \strong{CGO\,2017}: 15{\footnotesize th} International Symposium on Code Generation and Optimization
    \item \strong{PACT\,2016}: 25{\footnotesize th} Intl. Conference on Parallel Architectures and Compilation Techniques
  \end{itemize}
}
...
\cvline{}{\strong{Overall citations: 417}, \strong{h-index: 10}, \strong{i-index: 11}}
\cvline{}{\small (from Google Scholar accessed on the 2nd of July 2018)}
