...
\cvline{}{
  \begin{itemize}
    \item Artifact Evaluation Chair of the 16{\footnotesize th} International Symposium on Code Generation and Optimization, CGO 2018
    \item Web \& Publicity Chair of the 27{\footnotesize th} International Conference on Compiler Construction, CC 2018
    \item Local Organisation Chair of the 7{\footnotesize th} UK Many-Core Developer Conference, UKMAC 2017
\end{itemize}
}
\subsection{Program Committees}
\cvline{}{
  \begin{itemize}
    \item 10{\footnotesize th} Int. Symposium on High-Level Parallel Programming and Applications (HLPP\,2017)
    \item 9{\footnotesize th} Int. Symposium on High-Level Parallel Programming and Applications (HLPP\,2016)
    \item 16{\footnotesize th} IEEE Int. Conference on Scalable Computing and Communications (ScalCom\,2016)
\end{itemize}
}
...
\cvline{}{
  \begin{itemize}
    ...
    \item 15{\footnotesize th} Int. Symposium on Code Generation and Optimization (CGO\,2017)
    \item 25{\footnotesize th} Int. Conference on Parallel Architectures and Compilation Techniques (PACT\,2016)
  \end{itemize}
}
...
\cvline{\small Fall Term 2017}{%
  \begin{itemize}
    \item Lecturer \emph{\small Team Project Year 3} course.
    \item Supervised master group project: \emph{Developing a visual tool for exploring rewriting.}
  \end{itemize}
  }
