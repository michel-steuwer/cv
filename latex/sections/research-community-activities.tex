...
\begin{cvitemize}
  \item \strongHighlight{Reviewer for funding bodies}:
    \begin{inlineItemize}
      ...
      \item \highlight{Geman Federal Ministry of Education and Research (BMBF)}
    \end{inlineItemize}
\end{cvitemize}
...
\begin{cvitemize}
    \item Member of
      \begin{inlineItemize}
        ...
        \item the Institute for Computer Systems Architecture (\highlight{ICSA}) at the University of Edinburgh
        \item the Compiler and Architecture Design (\highlight{CArD}) Group at the University of Edinburgh
...
\begin{cvitemize}
  \item I am the \highlight{undergraduate year 1 organiser} coordinating the first year teaching of about 400 students at the School of Informatics in Edinburgh.
  \item I was the \highlight{research student committee convener} of the School of Computing Science at the University of Glasgow ({\small 2019-20}).
        Overseeing the academic progression of over 100 PhD students.
  \item I organised \highlight{Upwards}, a seminar series in Glasgow discussing all aspects of research life to facilitate knowledge sharing among academics and providing career advices.
