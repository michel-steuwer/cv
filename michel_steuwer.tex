...
\cvline{}{
  \begin{itemize}
    \item I co-organise the \emph{Programming Languages Interest Group} together with James Cheney, a group discussing a broad range of topics related to programming languages.
...
\cvline{}{
  \begin{itemize}
    ...
    \item Grigori Fursin and Anton Lokhmotov, dividiti
...
\cvline{}{
  \begin{itemize}
    ...
    \item Nominated as one of 34 candidates for the prize for best dissertation completed in 2015 in Informatics at a German, Austrian, or Swiss University.
          The prize is awarded by the German Informatics Society and the selection is currently ongoing.
...
\cvline{\small Fall Term 2015}{%
  \begin{itemize}
    ...
    \item Voluntary assistance in the tutorials of the \emph{Compiling Techniques} course held by Christophe Dubach.
  \end{itemize}
  }
\vspace{-1em}
